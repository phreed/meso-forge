...
def setup_environment(ns):
    ...
    # The default cache location might not be writable using linux container on macOS.
    if ns.config.startswith("linux") and platform.system() == "Darwin":
        os.environ["CONDA_FORGE_PODMAN_RUN_ARGS"] = "-e RATTLER_CACHE_DIR=/tmp/rattler_cache"


def run_podman_build(ns):
    script = ".scripts/run_podman_build.sh"
