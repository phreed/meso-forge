...
[source,bash]
----
pixi run build digitalpy pkgs linux-64
pixi run build digitalpy
----
...
The following examples builds packages in the `wip` folder.
[source,bash]
----
pixi run build bitwarden-cli wip
----
